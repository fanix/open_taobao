  ...
  module Traderates
    module Service
      ...
      def self.taobao_traderates_get(params, options = {})
        ...
        real_params["result"] => params["result"] if params["result"].present?
        real_params["page_no"] => params["page_no"] if params["page_no"].present?
        real_params["page_size"] => params["page_size"] if params["page_size"].present?
        real_params["start_date"] => params["start_date"] if params["start_date"].present?
        real_params["end_date"] => params["end_date"] if params["end_date"].present?
        real_params["tid"] => params["tid"] if params["tid"].present?
        real_params["num_iid"] => params["num_iid"] if params["num_iid"].present?
        real_params["use_has_next"] => params["use_has_next"] if params["use_has_next"].present?
